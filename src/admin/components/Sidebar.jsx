...
const navItems = [
  ...
  { id: 'brands', label: 'Brands', icon: (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M7 7h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
  )},
  ...
  { id: 'homepagecms', label: 'Homepage CMS', icon: (
  ...
  { id: 'features', label: 'Features Row', icon: (
